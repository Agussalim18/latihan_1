...
//error_reporting(0);
require 'koneksi.php';
$querry_data = mysqli_query($koneksi, "SELECT * FROM m_semester");
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
                <div class="row">
                    <div class="col-md-12">
                        <a href="dosen_tambah.php" class="btn btn-info">Tambah Data Prodi</a>
                            ...
                            <table class="table table-striped table-sm">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="dosen_ubah.php?id=<?= $row["kd_semester"]; ?>">ubah</a> |
                                            <a href="dosen_hapus.php?id=<?= $row["kd_semester"]; ?>"

...
//error_reporting(0);
require 'koneksi.php';
$querry_data = mysqli_query($koneksi, "SELECT * FROM `m_mahasiswa");
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
                <div class="row">
                    <div class="col-md-12">
                        <a href="tambah_mahasiswa.php" class="btn btn-info">Tambah Data mahasiswa</a>
                            ...
                            <table class="table table-striped table-sm">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $row["kd_prodi"]; ?></td>
                                        <td><?= $row["nm_mhs"]; ?></td>
                                        <td><?= $row["tempat_lhr_mhs"]; ?></td>
                                        <td><?= $row["agama"]; ?></td>
                                        <td><?= $row["jenis_klm_mhs"]; ?></td>
                                        <td><?= $row["tgl_msk_mhs"]; ?></td>
                                        <td><?= $row["alamat_mhs"]; ?></td>
                                        <td><?= $row["tlpn_mhs"]; ?></td>
                                        <td>
                                            <a href="mahasiswa_ubah.php">ubah</a> |
                                            <a href="mahasiswa_hapus.php"
